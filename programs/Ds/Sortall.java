...
class program381
{
    public static void main(String arr[])
    {
            ...
            aobj.InsertionSort();
            System.out.println("Data after sorting:InsertionSort");
            aobj.Display();

            aobj.BubbleSort();
             System.out.println("Data after sorting: BubbleSort");
            aobj.Display();

           aobj.SelectionSort();
             System.out.println("Data after sorting:SelectionSort");
            aobj.Display();
